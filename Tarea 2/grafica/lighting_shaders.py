...
class SimpleTextureGouraudShaderProgram():
    ...
    def set_light_attributes(self,current = 0):
     

        #Dependiendo el edificio, cambia la posicion de la Luz. Intenta imitar la luz real segun foto de Maps
        if current == 0:
            ...
            glUniform3f(glGetUniformLocation(self.shaderProgram, "lightPosition"), 1, 0, 2)
        ...
        if current == 1:
            ...
            glUniform3f(glGetUniformLocation(self.shaderProgram, "Kd"), 0.6, 0.6, 0.6)
            glUniform3f(glGetUniformLocation(self.shaderProgram, "Ks"), 1.0, 1.0, 1.0)
            glUniform3f(glGetUniformLocation(self.shaderProgram, "lightPosition"), -1, -1, 2)
            glUniform1ui(glGetUniformLocation(self.shaderProgram, "shininess"), 100)
            glUniform1f(glGetUniformLocation(self.shaderProgram, "constantAttenuation"), 0.001)
            glUniform1f(glGetUniformLocation(self.shaderProgram, "linearAttenuation"), 0.15)
            glUniform1f(glGetUniformLocation(self.shaderProgram, "quadraticAttenuation"), 0.01)
